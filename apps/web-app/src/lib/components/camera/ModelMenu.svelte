...
{#if open}
    <div class="model-menu" role="dialog" aria-label="Model settings">
        ...
        <label class="toggle-row">
            ...
            <input
                    type="checkbox"
                    checked={showLandmarksDebug}
                    onchange={onToggleLandmarksDebug}
            />
        </label>
...
<style>
    ...
    .ghost:hover { background: var(--surface-bg-soft); }
    .ghost.danger { color: rgba(255, 120, 120, 0.95); }
</style>