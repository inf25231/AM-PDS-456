...
<script lang="ts">
    ...
    const items = $derived([
        { key: "model" as const, icon: modelIcon, label: "Model" },
    ]);
    ...
    >
        ...
        {#if activeCategory === "model"}
            <ModelMenu
                    ...
                    showLandmarksDebug={showLandmarksDebug}
                    ...
                    cutoutsEnabled={cutoutsEnabled}
                    onToggleCutouts={onToggleCutouts}
                    onToggleLandmarksDebug={onToggleLandmarksDebug}
            />
        {/if}
        ...
        >
            <ToggleIcon
                    active={webcamHidden}
                    activeSrc={eyeClosedIcon}
                    inactiveSrc={eyeOpenIcon}
            />
        </PillButton>
    </div>
{/if}
