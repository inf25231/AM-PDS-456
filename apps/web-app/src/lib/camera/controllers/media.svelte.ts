 ...
 */
function stopCameraMedia(videoEl: HTMLVideoElement | undefined, cameraStream: MediaStream | null): void {
...
export class MediaController {
    ...
    async toggleCamera(): Promise<void> {
        if (this.cameraStream && this.#setTrackEnabled(this.cameraStream, 'video', !this.cameraEnabled)) {
            this.cameraEnabled = !this.cameraEnabled;
            if (this.cameraEnabled) {
                // Re-prime <video> playback after a soft re-enable.
                void this.#opts.getVideoElement()?.play().catch(() => {
